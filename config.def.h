...
static const char *toggle_volume[] = { "amixer","set","Master","toggle" };
static const char *increase_volume[] = { "amixer", "set", "Master", "5%+" };
static const char *decrease_volume[] = { "amixer", "set", "Master", "5%-" };
